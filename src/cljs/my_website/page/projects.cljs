...
(def project-page-body
  [:div {:id "project-body"}
   (box-container
     [(image-href-container "my-website"
                            classes
                            "https://github.com/AlbertSnows/MyWebsite"
                            (str image-dir "this_website.PNG")
                            "This Website")
      (project-description "This Website" "The website you're perusing")])
   (box-container
     [(image-href-container "first-website"
                            classes
   ...
   (box-container
     [(image-href-container "snake-game"
                            classes
   ...
   (box-container
     [(image-href-container "edgesweeper"
                            classes
                            "https://github.com/AlbertSnows/python-tkinter-minesweeper"
                            (str image-dir "minesweeper.PNG")
                            "Edgesweeper")
      (project-description "Edgesweeper" "Took Minesweeper, written in python, and added a feature")])
   (box-container
     [(image-href-container "first-unity"
                            classes
   ...
   (box-container
     [(image-href-container "mobile-app-game"
                            classes
                            "https://github.com/AlbertSnows/SimpleMobileGame"
                            (str image-dir "first_app.PNG")
                            "Simple App")
      (project-description "Simple App" "Playing with Java/Kotlin in Android Studio")])])
